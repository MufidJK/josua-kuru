...
export function VideoSection() {
  return (
    <section className="px-6 md:px-12 lg:px-24 py-24 md:py-32 max-w-350 mx-auto w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 flex justify-center lg:justify-end">
          <div className="w-full max-w-[320px] sm:max-w-90 lg:max-w-100 aspect-9/16 relative bg-[#EDE8DF] border border-border p-2 md:p-3">
            <video 
              controls 
              playsInline
